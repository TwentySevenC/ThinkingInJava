...
public class Functional {
	//Calls the Combiner object on each element to combine it 
	...
	//ignoring the return value. The function object may act as a collecting
	//parameter, so it is returned at the end.
	...
	//Applies a unary predicate to each item in a sequence. and returns a list of items
	//that produced "true":
	...
	//To use the above generic methods, we need to create function objects to adapt
	...
	static class BigDecimalUlp implements UnaryFunction<BigDecimal, BigDecimal> {
		...
		@Override
		public BigDecimal function(BigDecimal t) {
			return t.ulp();
		}
	...
	static class GreaterThan<T extends Comparable<T>> implements UnaryPredicate<T> {
		...
		public GreaterThan(T bounded) {
			this.bounded = bounded;
		}
		
		@Override
		public boolean test(T t) {
			return t.compareTo(bounded) > 0;
		}
	...
	static class MultiplyingIntegerCollector implements Collector<Integer> {
		...
		@Override
		public Integer function(Integer t) {
			val *= t;
			return val;
		}
